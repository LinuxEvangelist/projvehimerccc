...
<html lang="en">
	<head>
		...
		<!--[if !IE]> -->
		<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/pace.css" />

		<script data-pace-options='{ "ajax": true, "document": true, "eventLag": false, "elements": false }' src="${pageContext.request.contextPath}/resources/js/pace.js"></script>
 
		<!-- <![endif]-->
		
		<!-- Page Icon -->
		<link rel="shortcut icon" href="${pageContext.request.contextPath}/resources/img/lamb_logo.ico" />
